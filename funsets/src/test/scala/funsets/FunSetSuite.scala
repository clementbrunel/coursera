...
class FunSetSuite extends FunSuite {
  ...
  test("singletonSet(1) contains 1 and not 2") {
    ...
    new TestSets {
       ...
       */
      assert(contains(s1, 1) === true, "Singletoncontient")
      assert(contains(s1, 2) ===false, "Singletoncontientpas")
    }
  }
  ...
  test("intersect contains all elements") {
    new TestSets {
      ...
      assert(!contains(i, 1), "inter 1")
      assert(contains(i, 2), "inter 2")
      assert(!contains(i, 3), "inter 3")
    }
  }
